...
5. Personal US-equity / JLaw / Grok Bot investing → `investment/README.md` and `jlaw-investor`, not HQ finance.
6. Output in the router's fixed format. Do not deep-analyze before sensitivity is set.
