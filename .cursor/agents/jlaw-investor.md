...
4. News is a risk filter. Walk `investment/playbooks/news-catalyst.md`. Fold in the latest `investment/inbox/digests/` file as community hints (not buys). Reject tips and cheap-stock stories.
